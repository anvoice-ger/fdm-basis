...
**2. Recherche und Zuruf/Chatstorm:** Tandems recherchieren, tauschen sie aus und ausgewählte Tandems präsentieren im Plenum die Ergebnisse  (Videokonferenztool)
...
### Didaktische Methoden (online) für Sozialform: Partner*innenarbeit
**1. Präsentation/Selbstlernen:** Präsentation der Aufgabe: Studierende*r bekommt eine der folgenden Policies und soll diese inhaltlich analysieren und folgenden Fragen beantworten. (Videokonferenztool mit Präsentationstool)
...
Folgende Policies enthalten die oben genannten Elemente und schlüsseln diese auf: 
* Policy der Uni Mannheim: https://www.uni-mannheim.de/media/Einrichtungen/Abteilung_Kommunikation/Dokumente/forschung/Forschungsdaten-Policy.pdf
* Policy der Uni Wien https://rdm.univie.ac.at/de/fdm-policy-und-faq/

**2. Recherche und Notizen in Mindmap** Studierende recherchieren, und noiteren ihre Ergebnisse in einer Mindmap oder als Stichpunkte (Whiteboard oder Textwerkzeug)

**3. Präsenation:** Studierenden tragen die Ergebnisse im Plenum zusammne, oder präsentiert die Lehrperson präsentiert den Lösungsvorschlag zur Ergebnissicherung
