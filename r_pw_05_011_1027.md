...
Interaktive Abfrage vor einem Kurzvortrag per Zuruf oder Chatsturm: alle TN recherchieren selbstständig nach Leitlinien der DFG oder Beispiele für wissenschaftliches Fehlverhalten und tragen die Ergebnisse mündlich (oder im Chat) zusammen (Videokonferenztool). Oder die Teilnehmer:innen rufen Tools bzw. Software zur Erstellung von DMP in den (virtuellen) Raum.
